...
const Menu: FC<Props> = ({ onMenuClick, dense, logout }) => {
    ...
    return (
        <div>
            ...
            <MenuItemLink 
                to={'/masterProducts'}
                primaryText={'Master Products'}
                leftIcon={<masterProducts.icon />}
                onClick={onMenuClick}
                sidebarIsOpen={open}
                dense={dense}
            />
            <MenuItemLink 
                ...
                leftIcon={<productsServices.icon />}
                onClick={onMenuClick}
                sidebarIsOpen={open}
                dense={dense}
            />
            ...
            <MenuItemLink 
                to={'/shoppingZones'}
                primaryText={'Shopping Zones'}
                leftIcon={<shoppingZones.icon />}
                onClick={onMenuClick}
                sidebarIsOpen={open}
                dense={dense}
            />
